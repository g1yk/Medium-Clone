...
const Authentication = props => {
    ...
    // useContext - hook from react, im passing inside CurrentUserContext, context
    // i already created, in return im getting what i passed in value => {[state, setState]}
    // so in return im getting [currentUserState, setCurrentUserState]
